...
<div class="p-6">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Créer un nouveau post</h1>
        <p class="text-gray-600">Partagez vos idées, questions ou expériences avec la communauté</p>
    </div>
