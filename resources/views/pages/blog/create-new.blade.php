...
<div class="p-6">
    ...
    <div class="max-w-4xl">
        <!-- AI Generator Section (Initially Hidden) -->
        <div id="ai-section" class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border-2 border-purple-200 overflow-hidden shadow-lg mb-6 hidden">
            <div class="p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="ai-topic" class="block text-sm font-medium text-gray-700 mb-2">
                            Décrivez le sujet de votre article
                        </label>
                        <textarea 
                            id="ai-topic" 
                            rows="2"
                            placeholder="Ex: Les bienfaits de la plantation d'arbres urbains pour l'environnement..."
                            class="w-full px-4 py-3 border border-purple-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white"></textarea>
                    </div>
                    ...
                    <button type="button" id="generate-btn" class="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white rounded-lg font-medium transition-all shadow-lg">
                        ...
                        <span id="generate-text">Générer avec l'IA</span>
                    </button>
                    ...
                    <div id="ai-status" class="hidden">
                        <div class="flex items-center gap-2 text-sm text-purple-700 bg-purple-100 px-4 py-2 rounded-lg">
                            ...
                            <span id="status-text">Génération en cours...</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('blog.store') }}" class="p-8">
                ...
                <div class="mb-6">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <button type="button" onclick="generateTitle()" class="text-xs text-purple-600 hover:text-purple-700 font-medium hidden" id="gen-title-btn">
                ...
                <div class="mb-8">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <div class="flex gap-2 hidden" id="ai-tools">
                            <button type="button" onclick="improveContent('expand')" class="text-xs px-3 py-1 bg-purple-50 hover:bg-purple-100 text-purple-700 rounded font-medium transition-colors">
                                <i data-lucide="maximize-2" class="w-3 h-3 inline"></i> Développer
                            </button>
                            <button type="button" onclick="improveContent('shorten')" class="text-xs px-3 py-1 bg-purple-50 hover:bg-purple-100 text-purple-700 rounded font-medium transition-colors">
...
document.getElementById('generate-btn').addEventListener('click', async function() {
    ...
    try {
        ...
        if (data.success) {
            ...
            statusText.textContent = 'Contenu généré avec succès! ✨';
        ...
        btn.disabled = false;
        btnText.textContent = 'Générer avec l\'IA';
    }
});
