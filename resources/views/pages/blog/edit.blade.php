...
@section('title', 'Modifier le Post - blog')
...
<div class="p-6">
    ...
    <div class="max-w-4xl">
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-lg">
            <form method="POST" action="{{ route('blog.update', $blogPost) }}" class="p-8">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <select id="related_event_id" 
                        ...
                        @foreach($events as $event)
                            <option value="{{ $event->id }}" {{ old('related_event_id', $blogPost->related_event_id) == $event->id ? 'selected' : '' }}>
    ...
    <div class="bg-white rounded-2xl p-8 max-w-md mx-4">
        <div class="text-center">
            ...
            <div class="flex items-center gap-3 justify-center">
                ...
                <form method="POST" action="{{ route('blog.destroy', $blogPost) }}" class="inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit" 
